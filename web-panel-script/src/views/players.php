...
<section class="card">
    <div class="card-head">
        <div>
            <h1>Aktif Oyuncular</h1>
            <p class="muted">Online durumda olan oyuncular.</p>
        </div>
        <div class="card-actions">
            <form method="get" action="/players" class="search-form">
                <select name="by" aria-label="Filter">
                    ...
                    <option value="sid" <?php echo (($by ?? 'all') === 'sid') ? 'selected' : ''; ?>>SID</option>
                ...
                <input type="text" name="q" placeholder="Isim / License / Discord / Citizen ID / SID" value="<?php echo Util::e((string)($query ?? '')); ?>">
            </form>
        </div>
    </div>
        ...
        <table class="table">
            ...
            <tbody>
                <?php if (empty($players)): ?>
                    <tr><td colspan="7">Aktif oyuncu yok.</td></tr>
                <?php else: ?>
